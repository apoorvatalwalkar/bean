...
struct RenderShapeData {
    ...
    glm::mat4 inverse; //inverse of the ctm
    std::optional<Image*> image; //map
};
...
private:
    static void appendLists(glm::mat4 ctmToThisPoint, SceneNode* current, RenderData &renderData);
    static glm::mat4 getTransformation(SceneTransformation* current);
    static void addLight(glm::mat4 ctmToThisPoint, SceneLight* current, RenderData &renderData);
};
